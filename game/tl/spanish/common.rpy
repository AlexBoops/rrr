...
translate spanish strings:
    ...
    new "Esto cargará tus partidas guardadas en el {a=https://sync.renpy.org}Servidor de sincronización Ren'Py{/a}.\n¿Quieres continuar?"
    ...
    new "Puedes usar este ID para descargar tu archivo guardado en otro dispositivo.\nEsta sincronización caducará en una hora.\nRen'Py Sync cuenta con el respaldo de los {a=https://www.renpy.org/sponsors.html}patrocinadores de Ren'Py{/a}."
    ...
    new "Mientras descomprime {}, escribe {} desconocido."
