...
translate italian strings:
    ...
    new "{#weekday_short}Venerdì"

    # renpy/common/00action_file.rpy:37
    old "{#weekday_short}Sat"
    new "{#weekday_short}Sabato"
    ...
    new "I tuoi salvataggi verranno caricati sul {a=https://sync.renpy.org}Ren'Py Sync Server{/a}.\nVuoi continuare?"
    ...
    new "Durante il disimballaggio di {}, tipo sconosciuto {}."
    ...
    new "Forza il renderer GL"

    # renpy/common/00gltest.rpy:105
    old "Force ANGLE Renderer"
    new "Forza rendering ANGOLO"

    # renpy/common/00gltest.rpy:110
    old "Force GLES Renderer"
    new "Forza il renderer GLES"
    ...
    new "Maggiori dettagli su come risolvere questo problema sono disponibili nella {a=[url]}documentazione{/a}."
